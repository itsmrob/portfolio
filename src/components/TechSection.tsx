...
const TechSection: React.FC = () => {
    return (
        <section className='container mx-auto p-6 bg-gray-50 py-20'>
            <h2 className="text-xl font-bold text-center mb-4">My Tech Stack</h2>
            <p className="text-gray-600 text-center mb-6">Technologies I've been working with recently</p>
